...
We are removing the images that Todd put in for the original election game, so the images will not load up when you get the code.  Keep this in mind and change the data to point to your own images.
